...
def main() -> int:
    serial_port = sys.argv[1] if len(sys.argv) >= 2 else DEFAULT_SERIAL_PORT
...
if __name__ == "__main__":
    try:
        ...
        print("Usage: ./g1_left_wrist_serial.py [serial_port] [network_interface]", file=sys.stderr)
        print("Example sim:   ./g1_left_wrist_serial.py /dev/ttyACM0", file=sys.stderr)
        print("Example robot: ./g1_left_wrist_serial.py /dev/ttyACM0 enp2s0", file=sys.stderr)
        raise SystemExit(1)
