...
BRIDGE_CONFIG = BridgeConfig(
    ...
    joint_bindings=(
        ...
        JointBinding(name="left_shoulder_pitch", packet_index=0,  joint_index=15, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_shoulder_roll",  packet_index=1,  joint_index=16, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_shoulder_yaw",   packet_index=2,  joint_index=17, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_elbow",          packet_index=3,  joint_index=18, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_wrist_roll",     packet_index=4,  joint_index=19, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_wrist_pitch",    packet_index=5,  joint_index=20, kp=20.0, kd=1.0, scale=POT_SCALE),
        JointBinding(name="left_wrist_yaw",      packet_index=6,  joint_index=21, kp=20.0, kd=1.0, scale=POT_SCALE),
