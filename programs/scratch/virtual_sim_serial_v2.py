...
def main():
    ...
    commanded_left_offsets = [0.0] * 7
    commanded_right_offsets = [0.0] * 7
    ...
    try:
        ...
        while True:
            ...
            if packet is not None:
                ...
                commanded_left_offsets = list(desired_left_offsets)
                commanded_right_offsets = list(desired_right_offsets)

            left_target = [init + offset for init, offset in zip(left_init, commanded_left_offsets)]
            right_target = [init + offset for init, offset in zip(right_init, commanded_right_offsets)]
